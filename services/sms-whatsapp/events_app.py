...
<section class="card span12"><div class="top" style="margin-bottom:12px"><div><h2 style="margin:0">Seneste alarmhændelser</h2><p class="muted" style="margin:5px 0 0">Første alarm, komplet melding og Sending 2 samlet som én hændelse.</p></div><a class="btn" href="{{ url_for('alarm_statistics') }}">Alarmstatistik</a></div>
